...
//旗县收入环比通报
public class Qxsrhbtb extends BasicActivity implements OnActionSheetSelected, OnCancelListener ,OnDateSetListener{
	...
	private String[] key1 = { "qx", "zzSyyhs", "zzSysr", "zzDyyhs" ,"zzDysr","zzHbyhs","zzHbsr"};
	private String[] key2 = { "qx", "clYhs", "clSysr", "clDysr","clHbsr"};
	private String[] key3 = { "qx", "jlYhs", "jlSysr" };
	private String[] key4 = { "qx", "zlYhs", "zlDysr"};
	private String[] key5 = { "qx", "czYhs", "czSr"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.qxsrhbtb);

		// 设置标题栏
		super.setTitleBarWrap("旗县收入环比通报",DateUtil.getLastMonth(new java.util.Date()), View.VISIBLE, View.VISIBLE,
	...
	private void redrawUI() {
		...
		if(flag.equals("1")) {
			simpleAdapter = new SimpleAdapter(Qxsrhbtb.this, respdata,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						String subUrl = "tm/ZSJFAction.do?method=showYB4srhbtb4qx";
	...
	public void rightButtonOnClick() {
		this.getTitleRightButton().setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				ActionSheet.showSheet(Qxsrhbtb.this, Qxsrhbtb.this, Qxsrhbtb.this,"选择产品","选择日期");
			}
		});
	}
	...
	public void onClick(int whichButton) {
		...
		switch (whichButton) {
			case 0:
				Dialog dialog = new SelectDialog(Qxsrhbtb.this, R.style.selectDialog,"选择产品",areadata,areaMap,new SelectDialog.OnSelectItemgListener() {
