...
import com.cattsoft.mos.vo.svo.MosVersionSVO;
...
public class UpdateManager
{
	...
	String mosVersionUrl = "tm/ZSJFAction.do?method=getLateVersion4MOS";
	...
	public UpdateManager(BasicActivity context)
	{
...
//				.getResponseContentJSON(MosVersionJsonRes);
	...
	private int getVersionCode(Context context)
	{
		...
		try
		{
			...
			versionCode = context.getPackageManager().getPackageInfo("com.cattsoft.mos", 0).versionCode;
	...
	public void showDownloadDialog()
	{
		...
		builder.setNegativeButton(R.string.soft_update_cancel, new OnClickListener()
		{
			...
			public void onClick(DialogInterface dialog, int which)
			{
				...
				// 设置取消状态
				cancelUpdate = true;
				if (mosVersionSVO.getIsForce().equals("Y")) {
					CacheProcess cacheProcess = new CacheProcess();
					cacheProcess.clearCache(mosApp);
					mosApp.exit();
				}
