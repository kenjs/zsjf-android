 ...
 * 
 */
public class Sqwgzdywrb extends BasicActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sqwgzdywrb); 
	 
		super.setTitleBarWrap("商企网格重点业务日报",DateUtil.getYesterdayStr(), View.VISIBLE, View.VISIBLE,
	...
	private void redrawUI() {
		...
		if(flag.equals("1")) {
			simpleAdapter = new SimpleAdapter(Sqwgzdywrb.this, respdata,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						response = getPostHttpContent("", "tm/ZSJFAction.do?method=xyrb4sqwgzdywrb",
	...
	public void rightButtonOnClick() {
		this.getTitleRightButton().setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				datePickerDialog=new DatePickerDialog(Sqwgzdywrb.this,
