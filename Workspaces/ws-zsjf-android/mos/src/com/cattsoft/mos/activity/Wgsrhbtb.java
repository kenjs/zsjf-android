...
//网格收入环比通报
public class Wgsrhbtb extends BasicActivity implements OnActionSheetSelected, OnCancelListener ,OnDateSetListener{
	...
	private String[] key1 = { "wg", "zzSyyhs", "zzSysr", "zzDyyhs" ,"zzDysr","zzHbyhs","zzHbsr"};
	private String[] key2 = { "wg", "clYhs", "clSysr", "clDysr","clHbsr"};
	private String[] key3 = { "wg", "jlYhs", "jlSysr" };
	private String[] key4 = { "wg", "zlYhs", "zlDysr"};
	private String[] key5 = { "wg", "czYhs", "czSr"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wgsrhbtb);

		// 设置标题栏
		super.setTitleBarWrap("网格收入环比通报",DateUtil.getLastMonth(new java.util.Date()), View.VISIBLE, View.VISIBLE,
	...
	private void redrawUI() {
		...
		if(flag.equals("1")) {
			simpleAdapter = new SimpleAdapter(Wgsrhbtb.this, respdata,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						String subUrl = "tm/ZSJFAction.do?method=showYB4srhbtb4wg";
	...
	public void rightButtonOnClick() {
		this.getTitleRightButton().setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				ActionSheet.showSheet(Wgsrhbtb.this, Wgsrhbtb.this, Wgsrhbtb.this,"选择产品","选择日期");
			}
		});
	}
	...
	public void onClick(int whichButton) {
		...
		switch (whichButton) {
			case 0:
				Dialog dialog = new SelectDialog(Wgsrhbtb.this, R.style.selectDialog,"选择产品",areadata,areaMap,new SelectDialog.OnSelectItemgListener() {
