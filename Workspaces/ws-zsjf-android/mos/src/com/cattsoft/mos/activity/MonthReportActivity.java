 ...
 *
 */
public class MonthReportActivity extends BasicActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.setTitleBar("月通报",View.VISIBLE,View.INVISIBLE,View.INVISIBLE,false);
		initView(); 
...
//			};
			...
			public View getGroupView(int groupPosition, boolean isExpanded,
				...
				LinearLayout ll = new LinearLayout(
						MonthReportActivity.this);
				ll.setOrientation(0);
				ImageView logo = new ImageView(MonthReportActivity.this);
...
//						.setImageResource(generallogos[groupPosition][childPosition]);
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if(reportName.equals("收入环比通报(按客户群)")) {
					startActivity(new Intent(MonthReportActivity.this,
							Srhbtb.class));
				}else if(reportName.equals("收入环比通报(按业务)")){
					startActivity(new Intent(MonthReportActivity.this,
							Srhbtb4yw.class));
				}else if(reportName.equals("网格收入环比通报")) {
					startActivity(new Intent(MonthReportActivity.this,
							Wgsrhbtb.class));
				}else if(reportName.equals("旗县收入环比通报")) {
					startActivity(new Intent(MonthReportActivity.this,
							Qxsrhbtb.class));
				}else if(reportName.equals("3G业务月报")) {
					startActivity(new Intent(MonthReportActivity.this,
							G3ywyb.class));
				}
				return false;
