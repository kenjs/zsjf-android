...
//2g业务日报
public class G2ywrb extends BasicActivity {
	...
	private String[] key1 = { "gfzrbQy", "gfzrbRfz", "gfzrbDylj", "gfzrbSytqlj",
			"gfzrbZzs" };
	private String[] key2 = { "gfzrbQy", "gfzrbOcsRfz", "gfzrbOcsDylj", "gfzrbOcsSytqlj",
			"gfzrbOcsZzs" };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.g2bywfzrb);

		// 设置标题栏
		super.setTitleBarWrap("2G业务日报",DateUtil.getYesterdayStr(), View.VISIBLE, View.VISIBLE,
	...
	private void redrawUI() {
		...
		if(flag.equals("1")) {
			simpleAdapter = new SimpleAdapter(G2ywrb.this, respdata,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						String subUrl = "tm/ZSJFAction.do?method=hsrb42gyw";
	...
	public void rightButtonOnClick() {
		this.getTitleRightButton().setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				datePickerDialog=new DatePickerDialog(G2ywrb.this,
