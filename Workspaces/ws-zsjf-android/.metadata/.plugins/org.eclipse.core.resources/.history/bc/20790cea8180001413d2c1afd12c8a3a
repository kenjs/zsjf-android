...
//收入环比通报按业务
public class Srhbtb4yw extends BasicActivity implements OnCancelListener ,OnDateSetListener{
	...
	private String[] key1 = { "cp", "zzSyyhs", "zzSysr", "zzDyyhs" ,"zzDysr","zzHbyhs","zzHbsr"};
	private String[] key2 = { "cp", "clYhs", "clSysr", "clDysr","clHbsr"};
	private String[] key3 = { "cp", "jlYhs", "jlSysr" };
	private String[] key4 = { "cp", "zlYhs", "zlDysr"};
	private String[] key5 = { "cp", "czYhs", "czSr"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.srhbtb4yw);

		// 设置标题栏
		super.setTitleBarWrap("收入环比通报(按业务)",DateUtil.getLastMonth(new java.util.Date()), View.VISIBLE, View.VISIBLE,
	...
	private void redrawUI() {
		...
		if(flag.equals("1")) {
			simpleAdapter = new SimpleAdapter(Srhbtb4yw.this, respdata,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						String subUrl = "tm/ZSJFAction.do?method=showYB4srhbtb4yw";
	...
	public void rightButtonOnClick() {
		this.getTitleRightButton().setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				String lastMonth=DateUtil.getLastMonth(new java.util.Date());
				CustomerDatePickerDialog mDialog = new CustomerDatePickerDialog(Srhbtb4yw.this, Srhbtb4yw.this,
