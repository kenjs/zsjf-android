 ...
 * 
 */
public class Gcztxxtj extends BasicActivity {
	...
	String response = "";
	private String flag = ""; 
	private String[] key = { "gcmc", "dqhj", "sqr","sqsjStr"};
	com.alibaba.fastjson.JSONObject reqJson =null;
	
	public void onCreate(Bundle savedInstanceState) {
		this.requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
		super.onCreate(savedInstanceState);
		setContentView(R.layout.gcztxxtj);

		// 设置标题栏
		super.setTitleBarWrap("工程在途信息",DateUtil.getYesterdayStr(), View.VISIBLE, View.VISIBLE,
	...
	public void requestData() {
		Thread mThread = new Thread(new Runnable() {// 启动新的线程，
					@Override
					public void run() {
						String subUrl = "tm/ZSJFAction.do?method=showGCZTTJReport";
...
//				.parseObject(response);
		...
		simpleAdapter = new SimpleAdapter(Gcztxxtj.this, respdata,
				R.layout.list_item_gcztxx, key, new int[] { R.id.txt_head,
						R.id.txt_jgjsjgsj, R.id.txt_jgsjxqbm,R.id.txt_sqsjsqsj});
