...
public class WineDetailDialog extends Dialog{
	...
	public WineDetailDialog(Context context) {
        super(context);
        this.context = context;
       
	}
	 
	public WineDetailDialog(Context context, int theme,String title,List data,Map m,OnSelectItemgListener selectItemListener) {
		super(context, theme);
		this.context = context;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.dialog_winedetail);
